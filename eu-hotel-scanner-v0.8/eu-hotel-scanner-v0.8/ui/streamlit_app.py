...
def main():
    st.set_page_config(
        page_title="EU Hotel Scanner – v0.8",
        layout="wide",
    )

    st.title("EU Hotel Scanner – v0.8")
    st.caption(
        "Search optimiser for country choice: combines prior cost index with historical "
        "mispricing to decide which countries to scan and how deep to go."
    )
