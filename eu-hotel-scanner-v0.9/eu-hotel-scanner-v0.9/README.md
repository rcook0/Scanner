# EU Hotel Scanner – v0.9

This version delivers **packaging and a service layer** on top of the v0.8
...
```bash
docker build -t eu-hotel-scanner:0.9 .
docker run --rm -p 8000:8000 eu-hotel-scanner:0.9
```
